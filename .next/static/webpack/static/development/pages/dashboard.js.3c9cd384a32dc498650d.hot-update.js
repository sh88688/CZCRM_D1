...
function (_Component) {
  ...
  function Cards(props) {
    ...
    return Object(_babel_runtime_corejs2_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2__["default"])(this, Object(_babel_runtime_corejs2_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3__["default"])(Cards).call(this, props)); // this.state = {
    //     config: props.config,
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Cards, [{
    ...
    value: function render() {
      var _props = props,
          ...
          content = _props.content; //Can use type received in props???
      ...
      return __jsx(mdbreact__WEBPACK_IMPORTED_MODULE_6__["MDBCol"], {
        ...
        className: "iconHovered p-3 ".concat(this.props.config.color, "-gradient"),
        __source: {
          fileName: _jsxFileName,
          lineNumber: 20
        },
        ...
        __self: this
      }, this.props.config.header)), content)));
    }
  }]);

  return Cards;
}(react__WEBPACK_IMPORTED_MODULE_5__["Component"]); // const Cards = (props) => {
//     return(
//     );
// }
...
//# sourceMappingURL=dashboard.js.3c9cd384a32dc498650d.hot-update.js.map